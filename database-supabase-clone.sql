...
-- 3. Plak dit volledige script en voer het uit
-- 4. Configureer daarna de storage buckets (sectie 9)
-- 5. Configureer de edge functions secrets (sectie 10)
-- =============================================================================
...
-- Trigger function: koppelt nieuwe auth users aan bestaande leden of maakt nieuw lid aan
...
-- Auth trigger: automatisch lid aanmaken bij registratie
...
-- Maak storage buckets aan
INSERT INTO storage.buckets (id, name, public) VALUES ('profile-photos', 'profile-photos', false);
INSERT INTO storage.buckets (id, name, public) VALUES ('mailing-assets', 'mailing-assets', true);
INSERT INTO storage.buckets (id, name, public) VALUES ('receipts', 'receipts', false);

-- Storage policies: profile-photos (privaat, signed URLs)
...
-- Storage policies: mailing-assets (publiek leesbaar)
...
-- Storage policies: receipts (privaat)
...
-- =============================================================================
-- 9. NA HET UITVOEREN VAN DIT SCRIPT
-- =============================================================================
-- 
-- Configureer de volgende secrets in je Supabase project
-- (Dashboard > Project Settings > Edge Functions > Secrets):
--
--   SMTP_HOST          - SMTP server adres
